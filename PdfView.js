...
export default class PdfView extends Component {
  static propTypes = {
    ...
    onPinchInfoChanged: PropTypes.func,
  ...
  static defaultProps = {
    ...
    onPinchInfoChanged: (pinchInfo) => {
      console.log("onPinchInfoChanged: Default ... noone hooked");
    },
    onScroll: (data) => {
      console.log("onScroll: data", data);
    },
    onContentSizeChange: (data) => {
      console.log("onContentSizeChange: data", data);
    },
  };
  ...
  componentDidUpdate(prevProps) {
    if (this.props.scale !== this.state.scale) {
      console.log("call _onScaleChanged 1");
  ...
  _onItemDoubleTap = (index) => {
    if (this.state.scale >= this.props.maxScale) {
      console.log("call _onScaleChanged 2");
      this._onScaleChanged({
      ...
      console.log("call _onScaleChanged 3");
      this._onScaleChanged({
        scale: 1.2,
        pageX: this.state.contentContainerSize.width / 2,
        pageY: this.state.contentContainerSize.height / 2,
  ...
  _onScaleChanged = (pinchInfo) => {
    ...
    // console.log('_onScaleChanged: newScale>', newScale)
    ...
    console.log("about to call onPinchInfoChanged");
    this.props.onPinchInfoChanged(pinchInfo);
  };
  ...
  render() {
    return (
      <PinchZoomView
        ...
        onScaleChanged={(pinchInfo) => {
          console.log("call _onScaleChanged 4");
          this._onScaleChanged(pinchInfo);
        }}
      >
